...
/**
 * <h1>IsoscelesTriangle</h1>
 * The IsoscelesTriangle class is a class that
 * simply draws an Isosceles Triangle
 *
 *
 *
...
public class IsoscelesTriangle extends Triangle{
     ...
     */
    public IsoscelesTriangle(double xCoordinate, double yCoordinate, double layerWidth, double layerLength, Color color) throws PaintShopException {
    ...
    protected double[] verticesCalculator() {
        return new double[]{-50,40,45,40,-2.5,-84};
    }
}
