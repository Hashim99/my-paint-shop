...
/**
 * <h1>EquilateralTriangle</h1>
 * The EquilateralTriangle class is a class that
...
public class EquilateralTriangle extends Triangle {
     ...
     */
    public EquilateralTriangle(double xCoordinate, double yCoordinate, double layerWidth, double layerLength, Color color) throws PaintShopException {
    ...
    protected double[] verticesCalculator() {
        return new double[]{-50,40,74,40,12,-84};
    }
}
